...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: RFSKUOk__sQM/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: U7q-WXpwL8pf/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__u2Rs)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__nwG07)}
              />
            </React.Fragment>
          ),
          value: args.children
